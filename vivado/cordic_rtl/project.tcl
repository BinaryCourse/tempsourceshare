...
#
# Generated by Vivado on Tue May 19 18:31:05 +0430 2020
...
#
#    "/home/ali/work/git/tmp/ipcore_example/project/project.srcs/sources_1/bd/sinus_cosinus_system/sinus_cosinus_system.bd"
#    "/home/ali/work/git/tmp/ipcore_example/project/project.srcs/sources_1/bd/sinus_cosinus_system/hdl/sinus_cosinus_system_wrapper.vhd"
#    "/home/ali/work/git/tmp/ipcore_example/project/project.srcs/constrs_1/new/const.xdc"
#
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7s6cpga196-2
...
set_property -name "part" -value "xc7s6cpga196-2" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/project.srcs/sources_1/bd/sinus_cosinus_system/sinus_cosinus_system.bd"]\
 [file normalize "${origin_dir}/project.srcs/sources_1/bd/sinus_cosinus_system/hdl/sinus_cosinus_system_wrapper.vhd"]\
]
...
set file "sinus_cosinus_system/sinus_cosinus_system.bd"
...
set file "hdl/sinus_cosinus_system_wrapper.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "sinus_cosinus_system_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/project.srcs/constrs_1/new/const.xdc]"
...
set_property -name "target_part" -value "xc7s6cpga196-2" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s6cpga196-2 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s6cpga196-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
